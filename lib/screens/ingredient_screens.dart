...
class IngredientScreens extends StatefulWidget {
  final String title;
  final String img;
  final String dete;
  final bool count;

  const IngredientScreens({
    required this.title,
    required this.img,
    required this.dete,
    required this.count,
  ...
  @override
  State<IngredientScreens> createState() => _IngredientScreensState();
}

class _IngredientScreensState extends State<IngredientScreens> {
              ...
              children: [
                ...
                Container(
                  child: SelectDateButtonWidgets(
                    ...
                    buttonText: widget.dete != '' ? widget.dete : _birthDt,
